...
const iaFeatures: Feature[] = [
  ...
  // === Catálogo de Ferramentas e Fluxos ===
  {
    ...
    modulo: "IA",
    plataforma: "Painel Admin",
    descricao: "Página /admin/ai-tools que exibe o catálogo hardcoded de ferramentas (functions OpenAI) disponíveis no sistema: erp_invoice_search (Consulta de Faturas), erp_client_lookup (Busca Cliente por CPF/CNPJ) e erp_contract_lookup (Consulta de Contrato). Cada tool mostra handler, JSON Schema de parâmetros, descrição da resposta e flag requires_erp. Somente leitura — sem CRUD.",
    criticidade: "media",
    regrasNegocio: [
