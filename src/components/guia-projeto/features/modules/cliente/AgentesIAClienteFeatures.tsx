...
const agentesIAClienteFeatures: Feature[] = [
  ...
  },
  {
    ...
    modulo: "Agentes de IA",
    plataforma: "Painel Cliente",
    descricao: "Upload e gestão de documentos que alimentam o conhecimento do agente.",
    criticidade: "alta",
    regrasNegocio: [
      { codigo: "RN-CLI-224", descricao: "Suportar PDF, DOCX, TXT, MD" },
      { codigo: "RN-CLI-225", descricao: "Processar e indexar automaticamente" },
      { codigo: "RN-CLI-226", descricao: "Limite de documentos conforme plano" },
      { codigo: "RN-CLI-227", descricao: "Permitir adicionar FAQs manualmente" },
    ...
    entidades: [
      { nome: "Documento Conhecimento", campos: ["id", "agente_id", "nome", "tipo", "chunks", "created_at"] },
    ],
  },
  {
    codigo: "F-CLI-059",
