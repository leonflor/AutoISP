...
const PainelAdminSection = () => {
  const modulos = [
    ...
    { nome: "IA (5 sub-módulos)", icone: Bot, descricao: "Templates de agentes, catálogo de ferramentas (read-only), fluxos conversacionais globais, logs de processamento RAG, cláusulas LGPD" },
    { nome: "WhatsApp", icone: Bell, descricao: "Configuração global da Meta Business API, webhook URL, testes de conexão" },
