...
export function AgentFlowForm({ open, onOpenChange, agentId, flow }: AgentFlowFormProps) {
  ...
  useEffect(() => {
    if (flow) {
      form.reset({
        ...
        trigger_prompt: flow.trigger_prompt || '',
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] flex flex-col top-[5vh] translate-y-0">
        <DialogHeader>
          ...
          <DialogDescription>
            Define um roteiro conversacional para o agente seguir
          </DialogDescription>
        </DialogHeader>
