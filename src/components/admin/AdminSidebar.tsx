...
import { LayoutDashboard, Building2, Package, Users, Settings, LogOut, DollarSign, FileText, CreditCard, ChevronDown, MessageSquare, BarChart3, Bot, Shield, FileWarning, Workflow } from 'lucide-react';
...
const menuItems: MenuItem[] = [
  ...
  { 
    ...
    submenu: [
      ...
      { title: 'Procedimentos', url: '/admin/ai-procedures', icon: Workflow },
