  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Procedimentos de IA</h1>
          <p className="text-muted-foreground">Pacotes reutilizáveis de ferramentas e fluxos para agentes</p>
        </div>
      ...
      {isLoading ? (
        ...
        <Card>
          <CardContent className="py-12 text-center text-muted-foreground">
            ...
            <p>Nenhum procedimento criado ainda.</p>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {procedures.map(proc => (
            <Card key={proc.id} className="cursor-pointer hover:border-primary/50 transition-colors" onClick={() => navigate(`/admin/ai-procedures/${proc.id}`)}>
              ...
              <CardContent>
                ...
                <div className="flex items-center gap-4 text-xs text-muted-foreground">
                  <span>{proc.tools_count || 0} tools</span>
                  <span>{proc.flows_count || 0} fluxos</span>
                  <span>{proc.agents_count || 0} agentes</span>
                </div>
