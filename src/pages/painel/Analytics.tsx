...
export default function Analytics() {
  ...
  const { kpis, dailyData, handoverReasons, procedures, hourlyData, recentConversations, isLoading } = useConversationAnalytics({ period, ispId });
          ...
          <CardContent className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={procedures} layout="vertical">
                ...
                <Tooltip formatter={(value: number, name: string) => name === 'completion_rate' ? `${value}%` : value} />
