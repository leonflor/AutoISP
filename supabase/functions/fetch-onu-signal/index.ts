...
import { fetchClientSignal } from "../_shared/erp-driver.ts";
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const result = await fetchClientSignal(supabaseAdmin, membership.isp_id, encryptionKey, String(client_id));
