...
-- Insert v9 with improved step 0 and step 1 instructions
...
VALUES (
  ...
  'Procedimento para identificação de clientes com confirmação de identidade, listagem proativa de contratos, consulta de faturas em aberto e oferta de segunda via. v9: transição fluida entre steps e instruções proativas.',
  9,
  true,
  true,
  '{
