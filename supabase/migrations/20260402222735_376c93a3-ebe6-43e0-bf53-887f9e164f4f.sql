...
-- Desativar v16
UPDATE procedures SET is_current = false WHERE id = 'c0c349c2-4c4d-4ca1-aabe-a9e40bfe863c';

-- Inserir v17 com instrução de fechamento no Passo 5
...
VALUES (
  ...
  true,
  true,
  'Fluxo completo de cobrança: identificação → contrato → fatura → modalidade → entrega. V17: instrução de fechamento amigável no passo final.',
  '{
    "triggers": {
